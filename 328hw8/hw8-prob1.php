...
<!--
    ...
    you can run this using the URL: http://nrs-projects.humboldt.edu/~eg347/328hw8/hw8-prob1.php -->

<head>
    <title> CS 328 HW 8 Problem 1 </title>
    <meta charset="utf-8" />
    <?php
...
<body>
    ...
    elseif ($_SESSION["next_state"] == "pub_select")
    {
        ...
        session_destroy();
        ?>
        <p><a href="http://nrs-projects.humboldt.edu/~eg347/328hw8/hw8-prob1.php">
