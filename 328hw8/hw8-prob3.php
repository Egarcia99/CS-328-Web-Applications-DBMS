...
<!--
    ...
    you can run this using the URL: http://nrs-projects.humboldt.edu/~eg347/328hw8/hw8-prob3.php -->

<head>
    <title> CS 328 HW Problem 3 </title>
    <meta charset="utf-8" />
    <?php
...
<h3> Pet Store Databases</h3>
    ...
    elseif($_SESSION["next_step"] == "empl_raise")
    {
        ...
        session_destroy();
        ?>
        <p><a href="http://nrs-projects.humboldt.edu/~eg347/328hw8/hw8-prob3.php">
